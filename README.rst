...
.. |ci-badge| image:: https://github.com/edx/braze-client/workflows/Python%20CI/badge.svg?branch=master
    :target: https://github.com/edx/braze-client/actions
    :alt: CI

.. |codecov-badge| image:: https://codecov.io/github/edx/braze-client/coverage.svg?branch=master
    :target: https://codecov.io/github/edx/braze-client?branch=master
    :alt: Codecov
...
.. |license-badge| image:: https://img.shields.io/github/license/edx/braze-client.svg
    :target: https://github.com/edx/braze-client/blob/master/LICENSE.txt
    :alt: License
