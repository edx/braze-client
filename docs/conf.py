...
"""
braze-client documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'braze-client',  # Repo name
...
#
# html_title = 'braze-client v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Python client for interacting with Braze APIs',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'braze-client'),
                os.path.join(root_path, 'braze-client/migrations')])
